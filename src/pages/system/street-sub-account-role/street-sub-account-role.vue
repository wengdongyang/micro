<template>
  <page-layout>
    street-sub-account-role
    <table-pagination-layout class="street-sub-account-role">
...
<script lang="jsx" name="Street-sub-account-role" setup>
...
@import './street-sub-account-role.less';
</style>
